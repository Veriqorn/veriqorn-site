...
Veriqorn поддерживает индексацию кода из нескольких источников для AI-анализа: локальные пути, сетевые папки и удалённые Git-репозитории (GitHub, GitLab, Bitbucket, Azure DevOps).
...
2. Активирована лицензия Enterprise AI с entitlement `indexing`.
