...
Veriqorn поддерживает запросы к внешним системам (Sentry, Kibana, Grafana и др.) для получения дополнительных доказательств при Enterprise AI-анализе сбоев. Данное руководство описывает плагинную архитектуру и процесс добавления новых типов коннекторов.
