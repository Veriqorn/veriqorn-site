...
## 3) Instalar y conectar PostgreSQL

### Opcion A (recomendada para desarrollo local)

Utilice el archivo compose existente:

```bash
docker-compose -f docker-compose.dev.yml up
```

En `docker-compose.dev.yml` el backend ya recibe:
